    ...
    public partial class ScreenBehaviour : WizardScreen
    {
        ...
        private void load(OsuColour colours)
        {
            Content.Children = new Drawable[]
            {
                ...
                {
                    Text = @"Some new defaults for game behaviours have been implemented, with the aim of improving the game experience and making it more accessible to everyone.

We recommend you give the new defaults a try, but if you'd like to have things feel more like osu!stable, you can easily apply some sane defaults below.",
