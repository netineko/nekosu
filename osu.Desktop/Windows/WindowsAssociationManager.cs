...
namespace osu.Desktop.Windows
{
    ...
    public static class WindowsAssociationManager
    {
        ...
        /// </summary>
        private const string program_id_file_prefix = "nekosu.File";

        private const string program_id_protocol_prefix = "nekosu.Uri";

        private static readonly ApplicationCapability application_capability = new ApplicationCapability(@"nekosu", @"Software\netineko\nekosu\Capabilities", "neko!");
        ...
        {
            new UriAssociation(@"nekosu", WindowsAssociationManagerStrings.OsuProtocol, Icons.Lazer),
            new UriAssociation(@"nekosump", WindowsAssociationManagerStrings.OsuMultiplayer, Icons.Lazer),
        };
