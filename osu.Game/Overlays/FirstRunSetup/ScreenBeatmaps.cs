        ...
        private void load()
        {
            ...
            Content.Children = new Drawable[]
            {
                new OsuTextFlowContainer(cp => cp.Font = OsuFont.Default.With(size: CONTENT_FONT_SIZE))
                {
                    ...
                    Text = @"""Beatmaps"" are what we call sets of playable levels. neko! doesn't come with any beatmaps pre-loaded. This step will help you get started on your beatmap collection.",
