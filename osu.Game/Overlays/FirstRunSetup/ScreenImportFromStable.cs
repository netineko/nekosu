        ...
        private void load()
        {
            Content.Children = new Drawable[]
            {
                new LinkFlowContainer(cp => cp.Font = OsuFont.Default.With(size: CONTENT_FONT_SIZE))
                {
                    ...
                    Text = @"If you have an installation of osu!stable, you can choose to migrate your existing content. Note that whis will not affect your existing installation's files in any way.",
                    RelativeSizeAxes = Axes.X,
                    AutoSizeAxes = Axes.Y
                },
                stableLocatorTextBox = new StableLocatorLabelledTextBox
                {
                    Label = @"osu!stable install",
                    PlaceholderText = @"Click to locate your osu!stable install"
                },
                ...
                importButton = new ProgressRoundedButton
                {
                    ...
                    Text = @"Import content from osu!stable",
                    Action = runImport
                },
